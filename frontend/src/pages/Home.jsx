...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-10">
                Start solving company-specific DSA problems and land your dream
                ...
                {[
                  {
                    ...
                    desc: "Create your account and get instant access.",
                  },
                  {
                    step: "2",
                    title: "Choose your target company",
                    desc: "Filter problems by Google, Amazon, Microsoft, Meta & 50+ companies.",
                  },
                  {
                    step: "3",
                    title: "Solve & Track Progress",
                    desc: "Practice DSA problems, write code, and monitor your improvement.",
                  },
                ].map((item, idx) => (
      ...
      <section
        id="topics"
        className="pt-16 md:pt-24 pb-24 md:pb-32 relative bg-background"
        style={{ contentVisibility: "auto" }}
      >
        <div className="container mx-auto px-4 lg:px-16">
          <div className="text-center">
            <p className="text-sm md:text-base font-mono tracking-tight text-center">
              <span className="text-primary font-medium">import</span> languages{" "}
              <span className="text-primary">from</span> "@leet.io/compiler"
            </p>
            <p className="text-3xl md:text-4xl font-mono font-semibold mt-8 text-center text-foreground">
              Supported <span className="text-primary font-light">Programming</span>{" "}
              Languages
            </p>
          </div>
          ...
          <div className="mt-16">
            <div className="mx-auto text-center mb-8">
              <svg
                className="mx-auto h-24 text-primary opacity-50"
                viewBox="0 0 100 50"
                fill="currentColor"
              >
                <path
                  d="M50 5 L50 35 M45 30 L50 35 L55 30"
                  stroke="currentColor"
                  strokeWidth="2"
                  fill="none"
                />
          ...
          <div className="max-w-5xl w-full pt-6 bg-card border mx-auto mt-20 rounded-xl overflow-hidden relative">
            <p className="text-center text-sm text-muted-foreground font-mono font-medium">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="w-full" defaultValue="">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Leet-prep provides company-wise organized DSA problems, allowing
                you to target specific companies like Google, Amazon, or
                Microsoft. All problems are tagged by difficulty and topic,
                making focused interview prep easier.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>
                Which companies' interview questions are available?
              </AccordionTrigger>
              <AccordionContent>
                We cover 50+ top tech companies including FAANG (Facebook/Meta,
                Amazon, Apple, Netflix, Google), Microsoft, Adobe, Uber, Airbnb,
                and many more. New companies are added regularly.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Yes! We support all major programming languages including
                Python, Java, C++, JavaScript, TypeScript, and more. You can
                solve problems in your preferred language.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>Is Leet-prep free?</AccordionTrigger>
              <AccordionContent>
                Yes, Leet-prep offers a comprehensive free tier with access to
                500+ DSA problems. Premium features unlock advanced analytics,
                exclusive problems, and company-specific interview patterns.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-5">
              <AccordionTrigger>How do I track my progress?</AccordionTrigger>
              <AccordionContent>
                Your dashboard shows detailed statistics including problems
                solved by company, difficulty distribution, topic-wise progress,
                and streak tracking to keep you motivated.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-primary rounded-3xl p-12 md:p-20 text-primary-foreground relative overflow-hidden border">
            ...
            <p className="text-xl text-primary-foreground/70 mb-10 max-w-2xl mx-auto relative z-10">
              Join thousands of students who've landed offers at Google, Amazon,
              Microsoft, and more using Leet-prep.
            </p>

        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex justify-center">
              <fieldset
                className="bg-muted flex h-11 w-fit items-center rounded-lg p-1 text-sm"
            ...
            >
              {plans.map((plan) => (
                <article
                  ...
                  aria-label={`${plan.name} plan - ${isAnnually ? plan.yearlyPrice : plan.monthlyPrice
                ...
                >
                  <div className="mb-6">
                    ...
                    <div className="space-y-1">
                      ...
                      <p
                        className={`text-sm text-muted-foreground ${plan.monthlyPrice === "₹0" ? "invisible" : ""
                          }`}
                      >
                        {isAnnually ? "Per year" : "Per month"}
                      </p>
                  ...
                  <div className="flex flex-1 flex-col justify-between gap-8">
                    ...
                    {plan.name === "Free" ? (
                      ...
                      <PaymentButton
                        userId="12345"
                        amount={isAnnually ? plan.yearlyPrice : plan.monthlyPrice}
                        planName={plan.name}
                      />
                    )}
                  </div>
